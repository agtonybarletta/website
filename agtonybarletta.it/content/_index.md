...
I build this website to have a place to collect all my contacts and projects.
...
For many years now I have being playing with linux desktop envirnoments (gnome, xfce) and dynamic windows managers (dwm, awesomeWM).
...
My current laptop is a Thinkpad T480 (Intel i5-8350U) with the following mods:

- Screen placement: N140HCR-GL2 Touch FHD 14" Matte
- Keyboard replacement: US-backlighted
- SSD: Kingspec SSD M2 512GB NVME in WWAN slot
- HDD: Seagate BarraCuda, 2 TB 2.5"
